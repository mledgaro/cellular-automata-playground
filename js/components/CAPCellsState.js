class CAPCellsState
{
    ...
    {
        this.neighborhoods = 
            CellularAutomaton.inSituNeighborhoods(this.size, size, alignment);
    }

    setGroupedNeighborhoods(size)
    {
        this.neighborhoods = 
            CellularAutomaton.randomGroupedNeighborhoods(this.size, size);
    }

    setScatteredNeighborhood(size)
    {
        this.neighborhoods =
            CellularAutomaton.randomScatteredNeighborhoods(this.size, size);
    }
