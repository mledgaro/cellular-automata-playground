class GUI
{
    ...
    constructor()
    {
        this.dimensionSelectorBtn = new CAPToggleButton(
            GUI.IDS.dimensionSelectorBtn, ["1", "2"], "solid", "2xl");

        this.canvas = new CAPCanvas(
            GUI.IDS.canvasContainer, 0.95, 0.7);
        ...
        this.initialState = new GUISectionInitialState(
            this.canvas.maxColumns);
    ...
    #initSections()
    {
        this.sectionSelector.setOnClick(
            0, () => this.visibleSection = "neighborhood");

        this.sectionSelector.setOnClick(
            1, () => this.visibleSection = "rules");

        this.sectionSelector.setOnClick(
            2, () => this.visibleSection = "initialState");
    ...
    #initNeighborhoodSection()
    {
        ...
        this.neighborhood.d2.size.change(
            () => this.#updateRules2D());

        this.neighborhood.d2.type.change(
            () => this.#updateRules2D());
    ...
    #initRulesSection()
    {
        this.rules.maxRuleNumber = 
            this.neighborhood.maxRuleNumber;

        this.rules.reloadRules1D(
    ...
    #updateRules2D()
    {
        this.rules.reloadRules2D(
            this.neighborhood.getSize("d2"), this.neighborhood.getType("d2"));
    }
