class GUISectionInitialState
{
    ...
    constructor(cellsNumber)
    {
        ...
        this.clearBtn = new CAPButton(
            GUISectionInitialState.IDS.clearBtn, "Clear", "broom", "lg");

        this.random =
        {
            density: $("#" 
                + GUISectionInitialState.IDS.random.density),
            btn: new CAPButton(
        ...
        this.neighborhoodsBtn = new CAPButton(
            ...
            "Neighborhoods", "circle-nodes", "lg");

        this.cells = new CAPCellsState(
            GUISectionInitialState.IDS.cells, cellsNumber);
    ...
    reloadNeighborhoods(neighborhoodSize, neighborhoodType, 
        ...
        switch (neighborhoodType)
        {
            case "insitu":
                this.cells.setInSituNeighborhoods(
                    neighborhoodSize, neighborhoodAlignment);
                break;
